...
try {
  var _loop = function _loop() {
    ...
    var open = function open() {
      ...
      var _iterator6 = _createForOfIteratorHelper(backgrounds),
        _step6;
      try {
        for (_iterator6.s(); !(_step6 = _iterator6.n()).done;) {
          var background = _step6.value;
    ...
    if (bannerScrollTuors) {
      var _iterator8 = _createForOfIteratorHelper(bannerScrollTuors),
        _step8;
      try {
        for (_iterator8.s(); !(_step8 = _iterator8.n()).done;) {
          var bannerScrollTuor = _step8.value;
    ...
    if (bannerScrollTrainings) {
      var _iterator9 = _createForOfIteratorHelper(bannerScrollTrainings),
        _step9;
      try {
        for (_iterator9.s(); !(_step9 = _iterator9.n()).done;) {
          var bannerScrollTraining = _step9.value;
    ...
    if (bannerScrollAboutUss) {
      var _iterator10 = _createForOfIteratorHelper(bannerScrollAboutUss),
        _step10;
      try {
        for (_iterator10.s(); !(_step10 = _iterator10.n()).done;) {
          var bannerScrollAboutUs = _step10.value;
    ...
    if (bannerScrollFeedbacks) {
      var _iterator11 = _createForOfIteratorHelper(bannerScrollFeedbacks),
        _step11;
      try {
        for (_iterator11.s(); !(_step11 = _iterator11.n()).done;) {
          var bannerScrollFeedback = _step11.value;
    ...
    if (bannerScrollPhotogallerys) {
      var _iterator12 = _createForOfIteratorHelper(bannerScrollPhotogallerys),
        _step12;
      try {
        for (_iterator12.s(); !(_step12 = _iterator12.n()).done;) {
          var bannerScrollPhotogallery = _step12.value;
    ...
    if (bannerScrollContactss) {
      var _iterator13 = _createForOfIteratorHelper(bannerScrollContactss),
        _step13;
      try {
        for (_iterator13.s(); !(_step13 = _iterator13.n()).done;) {
          var bannerScrollContacts = _step13.value;
...
try {
  var _loop2 = function _loop2() {
    ...
    var open = function open() {
      ...
      buttonBox.style.background = '#ffffff';
      body.style.overflow = 'hidden';
      var _iterator14 = _createForOfIteratorHelper(backgrounds),
        _step14;
      try {
        for (_iterator14.s(); !(_step14 = _iterator14.n()).done;) {
          var background = _step14.value;
          background.classList.add('hero__overlay-open');
        }
      } catch (err) {
        _iterator14.e(err);
    ...
    var tours = document.querySelector('#tours');
    if (bannerScrollTuors) {
      var _iterator16 = _createForOfIteratorHelper(bannerScrollTuors),
        _step16;
      try {
        for (_iterator16.s(); !(_step16 = _iterator16.n()).done;) {
          var bannerScrollTuor = _step16.value;
          bannerScrollTuor.addEventListener('click', function (evt) {
            evt.preventDefault();
            tours.scrollIntoView({
              behavior: 'smooth',
    ...
    var training = document.querySelector('#training');
    if (bannerScrollTrainings) {
      var _iterator17 = _createForOfIteratorHelper(bannerScrollTrainings),
        _step17;
      try {
        for (_iterator17.s(); !(_step17 = _iterator17.n()).done;) {
          var bannerScrollTraining = _step17.value;
          bannerScrollTraining.addEventListener('click', function (evt) {
            evt.preventDefault();
            training.scrollIntoView({
              behavior: 'smooth',
    ...
    var aboutUs = document.querySelector('#about-us');
    if (bannerScrollAboutUss) {
      var _iterator18 = _createForOfIteratorHelper(bannerScrollAboutUss),
        _step18;
      try {
        for (_iterator18.s(); !(_step18 = _iterator18.n()).done;) {
          var bannerScrollAboutUs = _step18.value;
          bannerScrollAboutUs.addEventListener('click', function (evt) {
            evt.preventDefault();
            aboutUs.scrollIntoView({
              behavior: 'smooth',
    ...
    var feedback = document.querySelector('#feedback');
    if (bannerScrollFeedbacks) {
      var _iterator19 = _createForOfIteratorHelper(bannerScrollFeedbacks),
        _step19;
      try {
        for (_iterator19.s(); !(_step19 = _iterator19.n()).done;) {
          var bannerScrollFeedback = _step19.value;
          bannerScrollFeedback.addEventListener('click', function (evt) {
            evt.preventDefault();
            feedback.scrollIntoView({
              behavior: 'smooth',
    ...
    var photogallery = document.querySelector('#photogallery');
    if (bannerScrollPhotogallerys) {
      var _iterator20 = _createForOfIteratorHelper(bannerScrollPhotogallerys),
        _step20;
      try {
        for (_iterator20.s(); !(_step20 = _iterator20.n()).done;) {
          var bannerScrollPhotogallery = _step20.value;
          bannerScrollPhotogallery.addEventListener('click', function (evt) {
            evt.preventDefault();
            photogallery.scrollIntoView({
              behavior: 'smooth',
    ...
    var contacts = document.querySelector('#contacts');
    if (bannerScrollContactss) {
      var _iterator21 = _createForOfIteratorHelper(bannerScrollContactss),
        _step21;
      try {
        for (_iterator21.s(); !(_step21 = _iterator21.n()).done;) {
          var bannerScrollContacts = _step21.value;
          bannerScrollContacts.addEventListener('click', function (evt) {
            evt.preventDefault();
            contacts.scrollIntoView({
              behavior: 'smooth',
...
try {
  var _loop3 = function _loop3() {
    ...
    var open = function open() {
      ...
      buttonBox.style.background = '#ffffff';
      body.style.overflow = 'hidden';
      var _iterator22 = _createForOfIteratorHelper(backgrounds),
        _step22;
      try {
        for (_iterator22.s(); !(_step22 = _iterator22.n()).done;) {
          var background = _step22.value;
          background.classList.add('hero__overlay-open');
        }
      } catch (err) {
        _iterator22.e(err);
    ...
    var tours = document.querySelector('#tours');
    if (bannerScrollTuors) {
      var _iterator24 = _createForOfIteratorHelper(bannerScrollTuors),
        _step24;
      try {
        for (_iterator24.s(); !(_step24 = _iterator24.n()).done;) {
          var bannerScrollTuor = _step24.value;
          bannerScrollTuor.addEventListener('click', function (evt) {
            evt.preventDefault();
            tours.scrollIntoView({
              behavior: 'smooth',
    ...
    var training = document.querySelector('#training');
    if (bannerScrollTrainings) {
      var _iterator25 = _createForOfIteratorHelper(bannerScrollTrainings),
        _step25;
      try {
        for (_iterator25.s(); !(_step25 = _iterator25.n()).done;) {
          var bannerScrollTraining = _step25.value;
          bannerScrollTraining.addEventListener('click', function (evt) {
            evt.preventDefault();
            training.scrollIntoView({
              behavior: 'smooth',
    ...
    var aboutUs = document.querySelector('#about-us');
    if (bannerScrollAboutUss) {
      var _iterator26 = _createForOfIteratorHelper(bannerScrollAboutUss),
        _step26;
      try {
        for (_iterator26.s(); !(_step26 = _iterator26.n()).done;) {
          var bannerScrollAboutUs = _step26.value;
          bannerScrollAboutUs.addEventListener('click', function (evt) {
            evt.preventDefault();
            aboutUs.scrollIntoView({
              behavior: 'smooth',
    ...
    var feedback = document.querySelector('#feedback');
    if (bannerScrollFeedbacks) {
      var _iterator27 = _createForOfIteratorHelper(bannerScrollFeedbacks),
        _step27;
      try {
        for (_iterator27.s(); !(_step27 = _iterator27.n()).done;) {
          var bannerScrollFeedback = _step27.value;
          bannerScrollFeedback.addEventListener('click', function (evt) {
            evt.preventDefault();
            feedback.scrollIntoView({
              behavior: 'smooth',
    ...
    var photogallery = document.querySelector('#photogallery');
    if (bannerScrollPhotogallerys) {
      var _iterator28 = _createForOfIteratorHelper(bannerScrollPhotogallerys),
        _step28;
      try {
        for (_iterator28.s(); !(_step28 = _iterator28.n()).done;) {
          var bannerScrollPhotogallery = _step28.value;
          bannerScrollPhotogallery.addEventListener('click', function (evt) {
            evt.preventDefault();
            photogallery.scrollIntoView({
              behavior: 'smooth',
    ...
    var contacts = document.querySelector('#contacts');
    if (bannerScrollContactss) {
      var _iterator29 = _createForOfIteratorHelper(bannerScrollContactss),
        _step29;
      try {
        for (_iterator29.s(); !(_step29 = _iterator29.n()).done;) {
          var bannerScrollContacts = _step29.value;
          bannerScrollContacts.addEventListener('click', function (evt) {
            evt.preventDefault();
            contacts.scrollIntoView({
              behavior: 'smooth',
